...
namespace spt::mongoservice::api::model::request
{
  ...
  template <util::Visitable Document>
  void populate( Count<Document>& model, bsoncxx::document::view bson )
  {
    model.populate( bson );
  }

  template <util::Visitable Document>
  void populate( const Count<Document>& model, bsoncxx::builder::stream::document& builder )
  {
  ...
  template <util::Visitable Document>
  void populate( const Count<Document>& model, boost::json::object& object )
  {

...
namespace spt::mongoservice::api::model::request
{
  ...
  template <util::Visitable Document>
  void populate( DropIndex<Document>& model, bsoncxx::document::view bson )
  {
    model.populate( bson );
  }

  template <util::Visitable Document>
  void populate( const DropIndex<Document>& model, bsoncxx::builder::stream::document& builder )
  {
  ...
  template <util::Visitable Document>
  void populate( const DropIndex<Document>& model, boost::json::object& object )
  {

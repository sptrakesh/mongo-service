...
namespace spt::mongoservice::api::model::request
{
  ...
  template <util::Visitable Document>
  void populate( Index<Document>& model, bsoncxx::document::view bson )
  {
    model.populate( bson );
  }

  template <util::Visitable Document>
  void populate( const Index<Document>& model, bsoncxx::builder::stream::document& builder )
  {
  ...
  template <util::Visitable Document>
  void populate( const Index<Document>& model, boost::json::object& object )
  {

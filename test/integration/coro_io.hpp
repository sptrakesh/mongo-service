...
namespace coro_io
{
  ...
  std::enable_if_t<
      ( std::is_same_v<std::remove_reference_t<ObjType>, impl::tcp_socket> &&
          std::is_same_v<EndPoint, impl::tcp_endpoint> ) ||
          ( std::is_same_v<std::remove_reference_t<ObjType>, impl::udp_socket> &&
              std::is_same_v<EndPoint, impl::udp_endpoint> ),
      ...
      EndPoint ep, boost::posix_time::time_duration timeout )
  {
    ...
    return completion_type(
        [ep]( typename completion_type::coordinator_ptr& job_coordinator,
            NonRefObjType& ts )
        {
          ts.async_connect( ep,
              [job_coordinator]( const boost::system::error_code& ec )
              {
  ...
  async_connect( ObjType&& ts, EndPoint ep )
  {
    ...
    return completion_type(
        [ep]( completion_type& handler, NonRefObjType& ts )
        {
          ts.async_connect( ep,
      ...
      boost::posix_time::time_duration timeout )
  {
    ...
    return completion_type(
        [buffer]( typename completion_type::coordinator_ptr& job_coordinator,
            NonRefObjType& ts )
        {
          ts.async_send( buffer,
              [job_coordinator]( const boost::system::error_code& ec,
      ...
      boost::posix_time::time_duration timeout )
  {
    ...
    return completion_type( [buffer, flags](
        typename completion_type::coordinator_ptr& job_coordinator,
        NonRefObjType& ts )
    {
      ts.async_send( buffer, flags,
          [job_coordinator]( const boost::system::error_code& ec,
              std::size_t bytes_sent )
          {
            job_coordinator->done_with_result( ec, bytes_sent );
  ...
  async_send( ObjType&& ts, const ConstBufferSequence& buffer )
  {
    ...
    return completion_type(
        [buffer]( completion_type& handler, NonRefObjType& ts )
        {
          ts.async_send( buffer,
              [&handler]( const boost::system::error_code& ec,
                  std::size_t bytes_sent )
      ...
      boost::asio::socket_base::message_flags flags )
  {
    ...
    return completion_type(
        [buffer, flags]( completion_type& handler, NonRefObjType& ts )
        {
          ts.async_send( buffer, flags,
              [&handler]( const boost::system::error_code& ec,
                  std::size_t bytes_sent )
  ...
  std::enable_if_t<
      ...
      std::conditional_t<std::is_lvalue_reference_v<ObjType>, impl::rw_completion_or_timeout<thread_to_resume, std::remove_reference_t<ObjType>>,
          impl::rw_completion_or_timeout<thread_to_resume, std::remove_reference_t<ObjType>&&>>>
  async_write_at( ObjType&& ts, uint64_t offset,
      ...
      boost::posix_time::time_duration timeout )
  {
    ...
    return completion_type( [offset, buffer](
        typename completion_type::coordinator_ptr& job_coordinator,
        NonRefObjType& ts )
    {
      async_write_at( ts, offset, buffer,
          [job_coordinator]( const boost::system::error_code& ec,
              std::size_t bytes_sent )
          {
            job_coordinator->done_with_result( ec, bytes_sent );
      ...
      const ConstBufferSequence& buffer )
  {
    ...
    return completion_type(
        [buffer, offset]( completion_type& handler, NonRefObjType& ts )
        {
          async_write_at( ts, offset, buffer,
              [&handler]( const boost::system::error_code& ec,
                  std::size_t bytes_sent )
  ...
  std::enable_if_t<
      ...
      std::conditional_t<std::is_lvalue_reference_v<ObjType>, impl::rw_completion_or_timeout<thread_to_resume, std::remove_reference_t<ObjType>>,
          impl::rw_completion_or_timeout<thread_to_resume, std::remove_reference_t<ObjType>&&>>>
  async_read_at( ObjType&& ts, uint64_t offset,
      ...
      boost::posix_time::time_duration timeout )
  {
    ...
    return completion_type( [offset, buffer](
        ...
        NonRefObjType& ts )
    {
      async_read_at( ts, offset, buffer,
          [job_coordinator]( const boost::system::error_code& ec,
              std::size_t bytes_received )
          {
            job_coordinator->done_with_result( ec, bytes_received );
  ...
  std::enable_if_t<
      ...
      std::conditional_t<std::is_lvalue_reference_v<ObjType>, impl::completion_or_timeout<thread_to_resume, std::remove_reference_t<ObjType>>,
          impl::completion_or_timeout<thread_to_resume, std::remove_reference_t<ObjType>&&>>>
  async_accept( ObjType&& ts,
      boost::asio::basic_socket<Protocol, SocketService>& socket,
      boost::posix_time::time_duration timeout )
  {
    ...
    return completion_type(
        [&socket]( typename completion_type::coordinator_ptr& job_coordinator,
            NonRefObjType& ts )
        {
          ts.async_accept( socket,
              [job_coordinator]( const boost::system::error_code& ec )
              {
                job_coordinator->done_with_result( ec );
              } );
      ...
      boost::asio::basic_socket<Protocol, SocketService>& socket )
  {
    ...
    return completion_type(
        [&socket]( completion_type& handler, NonRefObjType& ts )
        {
          ts.async_accept( socket,
              [&handler]( const boost::system::error_code& ec )
              {

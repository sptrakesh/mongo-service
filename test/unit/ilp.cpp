...
readings,city=London,make=Omron temperature=23.6,humidity=0.348 1465839830100700000
    ...
    AND_WHEN( "Testing complex APMRecord" )
    {
      ...
      auto& p1 = record.processes.emplace_back( spt::ilp::APMRecord::Process::Type::Function );
      ...
      auto& p2 = record.processes.emplace_back( spt::ilp::APMRecord::Process::Type::Step );
      ...
      auto& p3 = record.processes.emplace_back( spt::ilp::APMRecord::Process::Type::Other );
